...
date_str="16:31"# thoi gian gui bao cao tong su dung vaf gui cho phu huynh
...
class UI(QtWidgets.QMainWindow, main_page.Ui_MainWindow):
    ...
    def suatuoi(self):
        ...
        if dangxuly==1 and vichat!=2:
            ...
            QMessageBox.about(self, "Title", "Bạn đang uống kẽm nên chỉ uống được các loại sữa thôi nhé")
        elif vichat==2:
            QMessageBox.about(self, "Title", "Bạn đang uống sắt nên chỉ uống được nước cam thôi nhé")
    def suadau(self):
    ...
    def ok(self):
        ...
        try:
            ...
            print(f'Something went wrong: {e}')
        last_status=''
        while True: #chuyeenr thnah false dder tesst
            global status
            print(status)
